...
function CategoryView({ category, onBack, onProductClick, addToCart }) {
  ...
  const allProducts = [
    ...
    { id: 7, name: 'Recliner Chair', description: 'Comfortable leather recliner with footrest', price: '₹599', image: 'https://m.media-amazon.com/images/I/61xvQzB8NFL._AC_UF894,1000_QL80_.jpg', stock: 6, category: 'Living Room' },
    ...
    { id: 8, name: 'Nightstand', description: 'Wooden nightstand with 2 drawers', price: '₹199', image: 'https://m.media-amazon.com/images/I/71QX7Q7HXQL._AC_UF894,1000_QL80_.jpg', stock: 12, category: 'Bedroom' },
    ...
    { id: 9, name: 'Bar Stools', description: 'Set of 2 adjustable bar stools', price: '₹249', image: 'https://m.media-amazon.com/images/I/61xvQzB8NFL._AC_UF894,1000_QL80_.jpg', stock: 8, category: 'Dining Room' },
    ...
    { id: 10, name: 'Office Chair', description: 'Ergonomic office chair with lumbar support', price: '₹299', image: 'https://m.media-amazon.com/images/I/71QX7Q7HXQL._AC_UF894,1000_QL80_.jpg', stock: 15, category: 'Office' },
    { id: 11, name: 'Storage Cabinet', description: 'Multi-purpose storage cabinet with shelves', price: '₹349', image: 'https://m.media-amazon.com/images/I/61xvQzB8NFL._AC_UF894,1000_QL80_.jpg', stock: 10, category: 'Storage' },
    { id: 12, name: 'Patio Set', description: 'Outdoor dining set for 4 people', price: '₹799', image: 'https://m.media-amazon.com/images/I/71QX7Q7HXQL._AC_UF894,1000_QL80_.jpg', stock: 4, category: 'Outdoor' }
  ]
